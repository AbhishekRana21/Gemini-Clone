...
function App() {
  ...
  return (
    <div className='App'>
        ...
        : <><div className="greet">
          <span className='colorGreet'>Hello, Abhishek</span>
          <span className=''>How can I help you today?</span>
        </div>
        <div className="suggestion">
          <button className='sgBtn' onClick={()=>setInput("As a social trend expert, explain a term")}>
          <span className='sgTxt'>As a social trend expert, explain a term</span>
          <img className='sgImg' src={assets.bulb_icon} alt="" />
          </button>
          <button className='sgBtn' onClick={()=>setInput("Suggest beaches to visit in a city, including details")}>
          <span className='sgTxt'>Suggest beaches to visit in a city, including details</span>
          ...
          <button className='sgBtn' onClick={()=>setInput("Explain HTML, CSS and JavaScript")}>
          <span className='sgTxt'>Explain HTML, CSS and JavaScript</span>
